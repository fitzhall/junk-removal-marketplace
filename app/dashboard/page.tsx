...
import { TruckIcon, ClockIcon, CheckCircleIcon, DocumentTextIcon } from '@heroicons/react/24/outline'
        ...
        <div className="bg-white shadow rounded-lg">
          ...
          <div className="p-6">
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">Get started by requesting your first quote.</p>
              <div className="mt-6">
                <Link
                  href="/"
